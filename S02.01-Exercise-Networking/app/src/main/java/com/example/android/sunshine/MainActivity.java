    ...
    class FetchWeatherTask extends AsyncTask<String, Void, String[]>{
        ...
        protected String[] doInBackground(String... strings) {
            ...
            for(String s : strings){
                URL url = NetworkUtils.buildUrl(s);
                try {
                    jsonResult = NetworkUtils.getResponseFromHttpUrl(url);
                } catch (IOException e) {
                    Log.e(MainActivity.class.getSimpleName(), "Problem with Http response", e);
                }
            }

            try {
                String[]  weatherResults = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, jsonResult);
